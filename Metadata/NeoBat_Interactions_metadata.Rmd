...
> **Site description:** The neotropical region is one of the eight biogeographic realms of the world and extends from southeastern United States to Patagonia, including the Caribbean and some pacific islands [@olson2001]. The region is comprised by 17 Phytogeographic Domains divided in 96 eco-regions including the Nearctic Mexico Domain [@oliveirafilho2017].
...
In these studies, capture is carried out mainly with mist nets, which adds a bias towards animals that fly in the understory and usually do not detect the nets [@tschapka1998compact]. Some studies used seed traps to collect the seeds rain under the canopy [@medellin1999seed; @arteaga2006seed].
...
**Wallacean Shortfall:** The lack of information about geographic distribution of species is a worldwide issue [@lomolino2004]. Despite the increasing effort to sample animals and plants separately, this effort is not enough to reduce this shortfall in the case of ecological interactions. Inferring ecological interactions only from co-occurrence data is not correct since interactions can be conditioned by another kind of biotic and abiotic processes, more than the simple presence of the two species in the same place at the same time [@Blanchet2020co].
...
**Eltonian Shortfall:** It refers to the lack of information about interactions among species [@hortal2015seven]. We have extended the definition of this shortfall as the lack of verification about the type of interaction that takes place between a pair of species. Roughly, we tend to assume that frugivory necessarily implies seed dispersal, and nectarivory necessarily implies pollination. We even tend to define both as mutualistic interactions, but these assumptions are imprecise and unclear without additional information. This issue gets even more complicated, when we consider that ecological interactions are not fixed in time and space. The effect of one species on the population dynamics of another can be modulated by internal factors such as population densities, and external factors such as environmental conditions [@hernandez1998dynamics]. This conditioning enables a context-dependent transition from mutualisms to antagonisms under variable environments. Overcoming this shortfall for bat-plant interactions requires considerable effort. Frugivory can only be assumed as mutualistic, if the balance between seed destruction and safe gut passage results in a fitness gain for the plant [@Genrich2017duality]. The benefit can be measured in terms of fruit production, the genetic variability of the propagules, or the dispersal distance of pollen to establish that the nectarivory represents a mutualistic interaction [@Flemingetal2009evolution].
...
> 1.  Mello, M. A. R., F. M. D. Marquitti, P. R. Guimarães Jr., E. K. V. Kalko, P. Jordano, M. A. M. de Aguiar, and P. R. Guimaraes.
>
>     2011. The missing part of seed dispersal networks: structure and robustness of bat-fruit interactions. PLoS One 6: e17395.
>
> 2.  Mello, M. A. R., F. M. D. Marquitti, P. R. Guimarães, E. K. V. Kalko, P. Jordano, and M. A. M. de Aguiar.
>
...
>
> 3.  Sarmento, R., C. P. Alves-Costa, A. Ayub, and M. A. R. Mello.
>
...
>
> 4.  Mello, M. A. R., F. A. Rodrigues, L. da F. Costa, W. D. Kissling, Ç.
>
...
>
> 5.  Mello, M. A. R., G. M. Felix, R. B. P. Pinheiro, R. L. Muylaert, C. Geiselman, S. E. Santana, M. Tschapka, N. Lotfi, F. A. Rodrigues, and R. D. Stevens.
>
